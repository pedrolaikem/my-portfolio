...
function Content() {
   return (
    <div>
        <div className="grid lg:grid-cols-2 sm:grid-cols-1 w-screen h-screen bg-white place-items-center">
            <div className='flex flex-col gap-2'>
                <div className=' w-[100%] font-inter font-extrabold md:text-[50px] sm:text-[25px] flex'>
                    ...
                    <h1 className='flex gap-3 items-end pb-5 relative sm:right-[70px] sm:top-3 md:right-[130px] md:top-0'>
                        <a href="https://www.linkedin.com/in/pedro-alveslima/"><img src={Linkedin} alt="linkedin-icon" className='w-6 items-center'/></a>
                        <a href="https://github.com/pedrolaikem"><img src={Github} alt="github-icon" className='w-6'/></a>
                    </h1>
                </div>
                <div className='flex flex-col gap-5'>
                    <h2 className='font-inter font-light text-xl sm:text-[19px] '> 
            ...
            <div id="foto"className='sm:w-[240px]'>
                <img src={fotoCurriculo} alt="foto-Pedro" className='rounded-[15px]'/>
            </div>      
        </div>
    </div>
   ) 
