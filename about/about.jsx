...
function AboutMe() {
    return (
        <div className='flex sm:flex-col md:flex-row md:text-start w-[100vw] md:h-[80vh] sm:h-[120vh] items-center justify-center border-black border-2'>
            <div className='flex w-[50%] justify-center'>
                <img src={Coding} alt="Codingimg" className='w-[500px]'/>
            </div>
            <div className='w-[50%]'>
                <div className='flex justify-start flex-col gap-2 '>
                    <h1 className='font-extrabold font-inter md:text-[25px] sm:text-[20px]'>Sobre mim</h1>
