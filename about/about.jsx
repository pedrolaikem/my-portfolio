        ...
        <div className='flex sm:flex-col md:flex-row md:text-start w-screen md:h-[80vh] sm:h-[130vh] items-center justify-center' >
            ...
            <div className='w-[50%]'>
                <div className='flex justify-start flex-col gap-2 '>
                    ...
                    <h3 className='font-inter md:text-[16px] text-gray-500 sm:text-[13px]'><Trans i18nKey="description.mainAboutMe">Olá, sou Pedro Henrique Alves Lima, tenho 23 anos, um desenvolvedor web com formação em direito. <br /><br />
